...
for PROJ in "${PROJECTS[@]}"; do
    ...
    if [ -d "$SEARCH_PATH/bin" ]; then
        ...
        # We want to preserve the structure starting from the "bin" folder's subdirectories
        # Example: Fontes/Sedex/bin/Windows/MT/Cdecl/ACBrSedex64.dll -> Output/Windows/MT/Cdecl/ACBrSedex64.dll
